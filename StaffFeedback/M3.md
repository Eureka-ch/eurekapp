...
You qualified for a Black Belt 🥋⚫ and got a final team grade of 5.54/6 for M3. Fantastic! You've demonstrated true mastery.
...
| **Design and Maintainability**           | 5.85 out of 6 | 20% | [See Details](#design-and-maintainability) |
| **QA (Testing)**                         | 5.59 out of 6           | 20%        | [See Details](#qa-testing)                 |
| **Documentation**                        | 5.2 out of 6 | 10%       | [See Details](#documentation)              |
| **Autonomy**                             | 6 out of 6     | 5%         | [See Details](#autonomy)                   |
| **Final Team Grade**                     | **5.54 out of 6** |            |                                            |
...
For this part, you received 5.59/6.
...
Based on the above points, your grade for this M3 milestone is 5.54/6. If you are interested in how this fits into the bigger grading scheme, please see [project README](https://github.com/swent-epfl/public/blob/main/project/README.md) and the [course README](https://github.com/swent-epfl/public/blob/main/README.md).
