...
You qualified for a Blue Belt 🥋🔵 and got a final team grade of 5.23/6 for M3. Excellent work! You're demonstrating advanced skills.
...
| **User Experience**                      | 5.3 out of 6 | 5%       | [See Details](#user-experience)            |
| **Design and Maintainability**           | 5.25 out of 6 | 20% | [See Details](#design-and-maintainability) |
| **QA (Testing)**                         | 5.14 out of 6           | 20%        | [See Details](#qa-testing)                 |
| **Documentation**                        | 4.9 out of 6 | 10%       | [See Details](#documentation)              |
| **Autonomy**                             | 6 out of 6     | 5%         | [See Details](#autonomy)                   |
| **Final Team Grade**                     | **5.23 out of 6** |            |                                            |
...
Your app is very well put together, except for the message reaction feature which was merged yet isn't working.
...
Good job overall, except for a couple issues: when a user is added to a project, they are not visible until the app is restarted; when filling forms, the values are rounded even when specifying >=1 decimals; the app crashes under certain conditions in TaskScreen
...
The UI doesn't let the users know that some fields are mandatory when creating a task if they haven't clicked on said field.

Some of the screens have big gaps/weird padding.
...
Some of your code is unecessarily complicated and you still introduced a signifcant amount of magic values.

You also don't have any fallbacks in case the APIs you use become unavailable.
...
Your tests still rely on delays, making them less robust than they should be.

You had issues with your Sonar reports and merged PR without any coverage checks.

For this part, you received 5.14/6.
...
The Figma is still not interactive.

You should have detailed the APIs you use in your readme or your wiki.

Some functions would have benefitted from being explained in more details, or even at all in some cases.
...
Based on the above points, your grade for this M3 milestone is 5.23/6. If you are interested in how this fits into the bigger grading scheme, please see [project README](https://github.com/swent-epfl/public/blob/main/project/README.md) and the [course README](https://github.com/swent-epfl/public/blob/main/README.md).
