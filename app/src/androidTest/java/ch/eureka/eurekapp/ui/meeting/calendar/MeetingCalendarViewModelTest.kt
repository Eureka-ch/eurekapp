...
class MeetingCalendarViewModelTest {
    ...
    fun checkIsMeetingRegisteredInCalendarWorks() = runTest {
        ...
        val fakeViewModel = MeetingCalendarViewModel(
    ...
    fun checkAddMeetingToCalendarWorks(){
        ...
        var success = false
        val result = fakeViewModel.addMeetingToCalendar(contentResolver,
            Meeting(status = MeetingStatus.SCHEDULED),
            onSuccess = {success = true}, onFailure = {})
    ...
    fun checkAddMeetingToCalendarDoesNotWork(){
        ...
        val result = fakeViewModel.addMeetingToCalendar(contentResolver,
            Meeting(status = MeetingStatus.SCHEDULED),
            onSuccess = {}, onFailure = {failure = true})
