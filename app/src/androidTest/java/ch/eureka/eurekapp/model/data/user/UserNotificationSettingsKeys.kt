...
class UserNotificationSettingsKeysTest {
  ...
  @Test
  fun userNotificationSettingsKeys_enumProperties() {
  ...
  @Test
  fun userNotificationSettingsKeys_defaultValuesMapSize() {
  ...
  @Test
  fun userNotificationSettingsKeys_defaultValuesMapContent() {
