...
class NotificationTypeTest {
    ...
    fun testEnumValueOfMethod() {
        assertEquals(NotificationType.GENERAL_NOTIFICATION, NotificationType.valueOf("GENERAL_NOTIFICATION"))
        assertEquals(NotificationType.MEETING_NOTIFICATION, NotificationType.valueOf("MEETING_NOTIFICATION"))
        assertEquals(NotificationType.MESSAGE_NOTIFICATION, NotificationType.valueOf("MESSAGE_NOTIFICATION"))
    }
