...
class SelfNotesRepositoryTest : FirestoreRepositoryTest() {
  ...
  @Test
  fun selfNotesRepository_createNoteShouldCreateNoteInFirestore() = runBlocking {
    val message =
        Message(
            messageID = "note1",
  ...
  @Test
  fun selfNotesRepository_getNotesShouldReturnAllNotes() = runBlocking {
  ...
  @Test
  fun selfNotesRepository_getNotesShouldOrderByCreatedAtDescending() = runBlocking {
    val message1 =
        Message(
            messageID = "note6",
            text = "Older note",
  ...
  @Test
  fun selfNotesRepository_getNotesShouldRespectLimit() = runBlocking {
    // Create 5 notes
    for (i in 1..5) {
      val message =
          Message(
  ...
  @Test
  fun selfNotesRepository_updateNoteShouldUpdateTextInFirestore() = runBlocking {
    val message =
        Message(
  ...
  @Test
  fun selfNotesRepository_updateNoteShouldFailIfNoteDoesNotExist() = runBlocking {
  ...
  @Test
  fun selfNotesRepository_deleteNoteShouldRemoveNoteFromFirestore() = runBlocking {
    val message =
        Message(
  ...
  @Test
  fun selfNotesRepository_deleteNoteShouldSucceedEvenIfNoteDoesNotExist() = runBlocking {
  ...
  @Test
  fun selfNotesRepository_createNoteShouldPreserveTimestamp() = runBlocking {
