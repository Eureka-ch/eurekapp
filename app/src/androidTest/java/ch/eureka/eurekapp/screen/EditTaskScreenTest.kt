...
open class EditTaskScreenTest : TestCase() {
  ...
  @Test
  fun editTaskScreen_testEmptyFieldsShowErrors() =
      runBlocking<Unit> {
  ...
  @Test
  fun editTaskScreen_testInvalidDateShowsError() =
      runBlocking<Unit> {
        val projectId = "project123"
        val taskId = "task123"
        setupTestProject(projectId)
  ...
  @Test
  fun editTaskScreen_testTaskLoadedCorrectly() =
      runBlocking<Unit> {
        val projectId = "project123"
        val taskId = "task123"
        setupTestProject(projectId)
  ...
  @Test
  fun editTaskScreen_testTakingPhotos() =
      runBlocking<Unit> {
        val projectId = "project123"
        val taskId = "task123"
        setupTestProject(projectId)
  ...
  @Test
  fun editTaskScreen_testTaskEdited() =
      runBlocking<Unit> {
        val projectId = "project123"
        val taskId = "task123"
        setupTestProject(projectId)
  ...
  @Test
  fun editTaskScreen_testTaskDeleted() =
      runBlocking<Unit> {
        val projectId = "project123"
        val taskId = "task123"
  ...
  @Test
  fun editTaskScreen_testStatusChange() =
      runBlocking<Unit> {
        val projectId = "project123"
        val taskId = "task123"
        setupTestProject(projectId)
  ...
  @Test
  fun editTaskScreen_testSaveButtonEnabledOnlyWithValidInput() =
      runBlocking<Unit> {
        val projectId = "project123"
        val taskId = "task123"
        setupTestProject(projectId)
  ...
  @Test
  fun editTaskScreen_testNavigateFromTasksToEditTask() =
      runBlocking<Unit> {
        val projectId = "project123"
        val taskId = "task123"
        setupTestProject(projectId)
  ...
  @Test
  fun editTaskScreen_testDependenciesLoadedFromTask() =
      runBlocking<Unit> {
        val projectId = "project123"
        val taskId = "task123"
  ...
  @Test
  fun editTaskScreen_testCurrentTaskIsExcludedFromAvailableTasks() =
      runBlocking<Unit> {
        val projectId = "project123"
        val taskId = "task123"
        val taskId1 = "task1"
  ...
  @Test
  fun editTaskScreen_testEditTaskWithDependenciesSavesDependencies() =
      runBlocking<Unit> {
        val projectId = "project123"
        val taskId = "task123"
        val dependencyId = "task1"
  ...
  @Test
  fun editTaskScreen_testRemoveDependencyRemovesFromList() =
      runBlocking<Unit> {
        val projectId = "project123"
        val taskId = "task123"
        val dependencyId = "task1"
  ...
  @Test
  fun editTaskScreen_testCycleErrorIsDisplayedWhenCycleDetected() =
      runBlocking<Unit> {
        val projectId = "project123"
        val taskId = "task123"
        val taskId1 = "task1"
  ...
  @Test
  fun editTaskScreen_testDeleteRemotePhotos() =
      runBlocking<Unit> {
        val projectId = "project123"
        val taskId = "task123"
  ...
  @Test
  fun editTaskScreen_testBackButtonNavigatesBack() {
    runBlocking {
      val projectId = "project123"
      val taskId = "task123"
      setupTestProject(projectId)
  ...
  @Test
  fun editTaskScreen_navigatesBackWhenConnectionLost() {
    runBlocking {
      val projectId = "project123"
      val taskId = "task123"
      setupTestProject(projectId)
      setupTestTask(projectId, taskId, title = "Test Task")
