...
// Part of this code and documentation were generated with the help of AI (ChatGPT 5.1 and Claude).
...
class HomeOverviewScreenEmulatorTest : TestCase() {
  ...
  @Test
  fun homeOverviewScreen_displaysRealDataFromFirebase() {
    runBlocking {
      // Setup test data
  ...
  @Test
  fun homeOverviewScreen_navigationButtonsWorkCorrectly() {
    runBlocking {
