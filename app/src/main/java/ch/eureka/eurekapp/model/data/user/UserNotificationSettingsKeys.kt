...
enum class UserNotificationSettingsKeys(val displayName: String,
                                        val notificationType: NotificationType) {
    //Meeting notifications
    ON_MEETING_SCHEDULED_NOTIFY("Notify when meeting scheduled: ",
    ...
    ON_NEW_MESSAGE_NOTIFY("Notify when a new message is sent: ",
