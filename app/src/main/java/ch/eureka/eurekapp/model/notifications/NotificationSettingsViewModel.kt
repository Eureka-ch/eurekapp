...
/**
 * ViewModel responsible for managing user notification preferences.
 * Handles interaction between the UI and the UserRepository to read/write settings.
 */
class NotificationSettingsViewModel(
    ...
    fun saveUserSetting(
        ...
        viewModelScope.launch {
            ...
            usersRepository.saveUser(updatedUser).fold(
                onSuccess = {
                    onSuccess()
                },
                onFailure = { error ->
    ...
    /**
     * Retrieves a stream of the current value for a specific notification setting.
     * If the user has not explicitly set a preference, a default value is returned.
     *
