 ...
 *
 * Implementations of this interface are responsible for creating, controlling, and deleting audio
 * recordings. All operations return a [Result] to indicate success or failure.
 *
...
interface AudioRecordingRepository {
   ...
   * @return A [Result] wrapping a [Uri] pointing to the newly created recording file on success, or
