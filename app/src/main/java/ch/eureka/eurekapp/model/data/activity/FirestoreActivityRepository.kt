...
class FirestoreActivityRepository(
  ...
  override fun getActivitiesByEntityType(
      projectId: String,
  ...
  override fun getActivitiesByActivityType(
      projectId: String,
  ...
  override suspend fun createActivity(activity: Activity): Result<String> = runCatching {
    val activityRef =
        firestore.collection(FirestorePaths.activitiesPath(activity.projectId)).document()
