...
class ProfileViewModelTest {
  ...
  @Test
  fun profileViewModel_initialStateHasNullUserAndNotEditing() {
    // Given
  ...
  @Test
  fun profileViewModel_loadUserProfileLoadsUserDataSuccessfully() = runTest {
    // Given
  ...
  fun profileViewModel_loadUserProfileThrowsExceptionWhenFirebaseUserIsNull() = runTest {
    // Given
  ...
  @Test
  fun profileViewModel_loadUserProfileUpdatesWhenUserDataChanges() = runTest {
    // Given
  ...
  @Test
  fun profileViewModel_setEditingUpdatesIsEditingStateToTrue() = runTest {
    // Given
    every { userRepository.getUserById("test-uid") } returns flowOf(testUser)
    viewModel = ProfileViewModel(userRepository)
    testDispatcher.scheduler.advanceUntilIdle()
  ...
  @Test
  fun profileViewModel_setEditingUpdatesIsEditingStateToFalse() = runTest {
    // Given
    every { userRepository.getUserById("test-uid") } returns flowOf(testUser)
    viewModel = ProfileViewModel(userRepository)
    viewModel.setEditing(true)
  ...
  @Test
  fun profileViewModel_updateDisplayNameSavesUserWithNewDisplayName() = runTest {
    // Given
    every { userRepository.getUserById("test-uid") } returns flowOf(testUser)
  ...
  @Test
  fun profileViewModel_updateDisplayNamePreservesOtherUserFields() = runTest {
    // Given
    every { userRepository.getUserById("test-uid") } returns flowOf(testUser)
    coEvery { userRepository.saveUser(any()) } returns Result.success(Unit)
    viewModel = ProfileViewModel(userRepository)
  ...
  @Test
  fun profileViewModel_updateDisplayNameSetsIsEditingToFalseAfterSave() = runTest {
    // Given
    every { userRepository.getUserById("test-uid") } returns flowOf(testUser)
    coEvery { userRepository.saveUser(any()) } returns Result.success(Unit)
    viewModel = ProfileViewModel(userRepository)
  ...
  @Test(expected = IllegalStateException::class)
  fun profileViewModel_updateDisplayNameThrowsExceptionWhenUserIsNull() = runTest {
    // Given
  ...
  @Test
  fun profileViewModel_updateDisplayNameHandlesEmptyString() = runTest {
    // Given
    every { userRepository.getUserById("test-uid") } returns flowOf(testUser)
    coEvery { userRepository.saveUser(any()) } returns Result.success(Unit)
    viewModel = ProfileViewModel(userRepository)
  ...
  @Test
  fun profileViewModel_updateDisplayNameHandlesVeryLongString() = runTest {
    // Given
  ...
  @Test
  fun profileViewModel_updateDisplayNameHandlesSpecialCharacters() = runTest {
    // Given
  ...
  @Test
  fun profileViewModel_userWithEmptyPhotoUrlIsHandledCorrectly() = runTest {
    // Given
  ...
  @Test
  fun profileViewModel_updateDisplayNameHandlesRepositorySaveFailure() = runTest {
    // Given
    every { userRepository.getUserById("test-uid") } returns flowOf(testUser)
  ...
  @Test
  fun profileViewModel_updateDisplayNameWithUnicodeCharacters() = runTest {
    // Given
  ...
  @Test
  fun profileViewModel_multipleRapidUpdateDisplayNameCalls() = runTest {
    // Given
    every { userRepository.getUserById("test-uid") } returns flowOf(testUser)
    coEvery { userRepository.saveUser(any()) } returns Result.success(Unit)
    viewModel = ProfileViewModel(userRepository)
  ...
  @Test
  fun profileViewModel_setEditingMultipleTimesInQuickSuccession() = runTest {
    // Given
    every { userRepository.getUserById("test-uid") } returns flowOf(testUser)
    viewModel = ProfileViewModel(userRepository)
    testDispatcher.scheduler.advanceUntilIdle()
  ...
  @Test
  fun profileViewModel_updateDisplayNamePreservesTimestampAccurately() = runTest {
    // Given
  ...
  @Test
  fun profileViewModel_userFlowEmitsMultipleValuesRapidly() = runTest {
    // Given
    val flow =
  ...
  @Test
  fun profileViewModel_updateDisplayNameMaintainsUidConsistency() = runTest {
    // Given
    every { userRepository.getUserById("test-uid") } returns flowOf(testUser)
    coEvery { userRepository.saveUser(any()) } returns Result.success(Unit)
    viewModel = ProfileViewModel(userRepository)
  ...
  @Test
  fun profileViewModel_updateDisplayNameWithWhitespaceOnlyString() = runTest {
    // Given
    every { userRepository.getUserById("test-uid") } returns flowOf(testUser)
    coEvery { userRepository.saveUser(any()) } returns Result.success(Unit)
    viewModel = ProfileViewModel(userRepository)
  ...
  @Test
  fun profileViewModel_updateDisplayNameWithNewlineCharacters() = runTest {
    // Given
  ...
  @Test
  fun profileViewModel_userWithNullEmailIsHandledCorrectly() = runTest {
    // Given
  ...
  @Test
  fun profileViewModel_updateDisplayNamePreservesEmailWhenUpdating() = runTest {
    // Given
    every { userRepository.getUserById("test-uid") } returns flowOf(testUser)
    coEvery { userRepository.saveUser(any()) } returns Result.success(Unit)
    viewModel = ProfileViewModel(userRepository)
  ...
  @Test
  fun profileViewModel_setEditingTrueDoesNotTriggerSave() = runTest {
    // Given
    every { userRepository.getUserById("test-uid") } returns flowOf(testUser)
    viewModel = ProfileViewModel(userRepository)
    testDispatcher.scheduler.advanceUntilIdle()
  ...
  @Test
  fun profileViewModel_setEditingFalseDoesNotTriggerSave() = runTest {
    // Given
    every { userRepository.getUserById("test-uid") } returns flowOf(testUser)
    viewModel = ProfileViewModel(userRepository)
    viewModel.setEditing(true)
  ...
  @Test
  fun profileViewModel_updateDisplayNameWithSameNameStillTriggersSave() = runTest {
    // Given
    every { userRepository.getUserById("test-uid") } returns flowOf(testUser)
    coEvery { userRepository.saveUser(any()) } returns Result.success(Unit)
    viewModel = ProfileViewModel(userRepository)
  ...
  @Test
  fun profileViewModel_userStateIsNullInitiallyBeforeRepositoryReturns() {
    // Given
    every { userRepository.getUserById("test-uid") } returns flowOf(testUser)
  ...
  @Test
  fun profileViewModel_updateDisplayNameWithTrailingAndLeadingWhitespace() = runTest {
    // Given
  ...
  @Test
  fun profileViewModel_updateDisplayNameAfterSetEditingFalseStillWorks() = runTest {
    // Given
    every { userRepository.getUserById("test-uid") } returns flowOf(testUser)
    coEvery { userRepository.saveUser(any()) } returns Result.success(Unit)
    viewModel = ProfileViewModel(userRepository)
